...
-- awful.spawn.with_shell('autorandr --change --default beegbois')
...
awful.spawn.with_shell('pgrep -x musikcubed > /dev/null/ || musikcubed')
awful.spawn.with_shell('pgrep -x syncthing serve --no-browser > /dev/null/ || syncthing serve --no-browser')
-- awful.spawn.with_shell('pgrep -x gajim > /dev/null/ || gajim')
